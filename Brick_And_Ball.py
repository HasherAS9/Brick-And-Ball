...
# font
font = pygame.font.SysFont('Bradley Hand ITC', 30)
        ...
        for row in wall.blocks:
            ...
            for item in row:
                ...
                if self.rect.colliderect(item[0]):
                    # collision was from above
                    if abs(self.rect.bottom - item[0].top) < collision_thresh and self.speed_y > 0:
                        self.speed_y *= -1
                    # collision was from below
                    if abs(self.rect.top - item[0].bottom) < collision_thresh and self.speed_y < 0:
                        self.speed_y *= -1
                    # collision was from left
                    if abs(self.rect.right - item[0].left) < collision_thresh and self.speed_x > 0:
                        self.speed_x *= -1
                    # collision was from right
...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text('CLICK ANYWHERE TO START', font, start_col, 100, screen_height // 2 + 100)
        elif game_over == 1:
            draw_text('YOU WON!', font, win_col, 240, screen_height // 2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, start_col, 100, screen_height // 2 + 100)
        elif game_over == -1:
            draw_text('YOU LOST!', font, lost_col, 240, screen_height // 2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, start_col, 100, screen_height // 2 + 100)
